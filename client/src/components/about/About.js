    ...
    <div className='about'>
      ...
      <ul className='about-container'>
        <a href='https://github.com/HewsonSchulz' target='_blank' rel='noopener noreferrer' className='about__item'>
          <img className='about__img about__github' src='/assets/github-icon.svg' alt='Github icon' />
        ...
        <a
          ...
          <img className='about__img about__linkedin' src='/assets/linkedin-icon.svg' alt='LinkedIn icon' />
        ...
        <a
          ...
          rel='noopener noreferrer'
          className='about__item'>
          <img className='about__img about__nss' src='/assets/nss-icon.svg' alt='Nashville Software School icon' />
        ...
        <a
          ...
          rel='noopener noreferrer'
          className='about__item'>
          <img className='about__img about__resume' src='/assets/doc-icon.svg' alt='resume icon' />
