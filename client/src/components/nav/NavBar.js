    ...
    <>
      <ul className='header'>
        <li className='header-item header__title'>
          <img className='header__icon' src='/Turtle/assets/turtle-icon.png' alt='turtle custard flavor' />
          <img className='header__text' src='/Turtle/assets/turtle-title.png' alt='turtle logo' />
        </li>
